...
WITH expected(table_name, column_name) AS (VALUES
  ...
  ('product_batches','receipt_reversed_at'),
...
WITH expected(function_name) AS (VALUES
  ...
  ('zidu_create_purchase_order_v2'),('zidu_update_purchase_order_v2'),
  ('zidu_restore_deleted_purchase_order'),('zidu_close_purchase_order'),
  ('zidu_reverse_purchase_receipt'),
  ('zidu_adjust_inventory'),('zidu_adjust_raw_inventory'),('zidu_fifo_consume_batches'),
  ('zidu_adjust_inventory_from_batch'),
